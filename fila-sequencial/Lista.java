public class Lista<E> {
    ...
    public void inserir(E novo, int posicao){
        ...
        if (cheia()){
            throw new IllegalStateException("Não foi possível inserir o item da lista: " + "a lista está cheia!")
        }
    ...
    public E pesquisar(E procurado) {
        ...
        throw new NoSuchElementExceptiop("Item não encontrado!");
    }
}